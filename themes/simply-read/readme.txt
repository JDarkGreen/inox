...
SIMPLY READ WordPress Theme, Copyright 2014 http://wpsimplyread.com/
SIMPLY READ is distributed under the terms of the GNU GPL
...
-> http://pixabay.com/en/guitarist-acoustic-guitar-man-boy-407212/
-> http://pixabay.com/en/ely-cathedral-colossal-church-414090/
-> http://pixabay.com/en/tire-wheel-vintage-antique-old-416189/
-> http://pixabay.com/en/laundry-washing-machines-housewife-413688/
...
* fixed the first submenu alignment
...
* re-structured html
* added Tags and Next/Previous Post on Single Post Area

Version 1.0.7
* remove the jquery and css minified version files
...
* Remove theme suport custom header

Version 1.0.4
* updated the comments layout

Version 1.0.3
* Updated simplyread.php
* Updated function.php

Version 1.0.2
* Updated the readme.txt
* removed all scripts in the header.php
* updated the header.php and simplyread.php
